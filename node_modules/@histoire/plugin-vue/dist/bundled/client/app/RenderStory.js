...
import { defineComponent as V, ref as x, onMounted as _, watch as j, onBeforeUnmount as T, h as k } from "@histoire/vendors/vue";
import * as h from "virtual:$histoire-generated-global-setup";
import * as v from "virtual:$histoire-setup";
import { reactive as q, createApp as F, onMounted as O, h as S, Suspense as B } from "vue";
    ...
    async function w() {
      ...
      a = F({
        ...
        render: () => {
          ...
          return t.push(S("div", t.at(-1))), t.push(S(B, {}, t.at(-1))), t.at(-1);
        }
