...
let files = [
  ...
  { "id": "src-components-design-tokens-hstcolorshades-story-vue", "path": ["design-tokens", "HstColorShades"], "story": { "id": "src-components-design-tokens-hstcolorshades-story-vue", "title": "HstColorShades", "group": null, "layout": { "type": "single", "iframe": true }, "icon": null, "iconColor": null, "docsOnly": false, "variants": [{ "id": "src-components-design-tokens-hstcolorshades-story-vue-0", "title": "default", "icon": null, "iconColor": null }, { "id": "src-components-design-tokens-hstcolorshades-story-vue-1", "title": "background", "icon": null, "iconColor": null }, { "id": "src-components-design-tokens-hstcolorshades-story-vue-2", "title": "text", "icon": null, "iconColor": null }, { "id": "src-components-design-tokens-hstcolorshades-story-vue-3", "title": "border", "icon": null, "iconColor": null }, { "id": "src-components-design-tokens-hstcolorshades-story-vue-4", "title": "with search", "icon": null, "iconColor": null }, { "id": "src-components-design-tokens-hstcolorshades-story-vue-5", "title": "long names", "icon": null, "iconColor": null }] }, "framework": "vue3", "index": 1, component: Comp1 },
  { "id": "src-components-design-tokens-hsttokengrid-story-vue", "path": ["design-tokens", "HstTokenGrid"], "story": { "id": "src-components-design-tokens-hsttokengrid-story-vue", "title": "HstTokenGrid", "group": null, "layout": { "type": "single", "iframe": true }, "icon": null, "iconColor": null, "docsOnly": false, "variants": [{ "id": "src-components-design-tokens-hsttokengrid-story-vue-0", "title": "default", "icon": null, "iconColor": null }] }, "framework": "vue3", "index": 2, component: Comp2 },
...
const toRawObject = (obj) => Object.keys(obj).reduce((raw, key) => {
...
const computePosition$1 = async (reference, floating, config2) => {
  ...
  let {
    x,
    y
  } = computeCoordsFromPlacement(__spreadProps$1(__spreadValues$1({}, rects), {
    placement
  }));
...
async function detectOverflow(middlewareArguments, options) {
  ...
  const elementClientRect = rectToClientRect(await platform2.convertOffsetParentRelativeRectToViewportRelativeRect({
    rect: elementContext === "floating" ? __spreadProps$1(__spreadValues$1({}, rects.floating), {
      x,
      y
    }) : rects.reference,
...
function convertValueToCoords(_ref) {
  ...
  const rawValue = typeof value === "function" ? value(__spreadProps$1(__spreadValues$1({}, rects), {
    placement
  })) : value;
  const {
    mainAxis,
...
const shift = function(options) {
  ...
  return {
    ...
    async fn(middlewareArguments) {
      ...
      const limitedCoords = limiter.fn(__spreadProps$1(__spreadValues$1({}, middlewareArguments), {
...
const platform = {
  getElementRects: (_ref) => {
    ...
    return {
      ...
      floating: __spreadProps$1(__spreadValues$1({}, getDimensions(floating)), {
        x: 0,
        y: 0
      })
    };
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent(__spreadProps$1(__spreadValues$1({}, __default__$6), {
  props: {
    title: null,
    modelValue: null
  },
...
const render = (icon, props) => {
  ...
  let style = typeof props.style === "object" && !(props.style instanceof Array) ? __spreadValues$1({}, props.style) : {};
...
const Icon = defineComponent({
  ...
  render() {
    ...
    let newProps = props;
    if (icon.classes) {
      newProps = __spreadProps$1(__spreadValues$1({}, props), {
...
const _sfc_main$5 = defineComponent(__spreadProps$1(__spreadValues$1({}, __default__$5), {
  props: {
    modelValue: null,
    options: null
  },
...
const _sfc_main$4 = defineComponent(__spreadProps$1(__spreadValues$1({}, __default__$4), {
  props: {
    title: null,
    modelValue: null,
    options: null
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent(__spreadProps$1(__spreadValues$1({}, __default__$3), {
  props: {
    content: null
  },
  setup(__props) {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent(__spreadProps$1(__spreadValues$1({}, __default__$2), {
  props: {
    shades: null,
    getName: null,
    search: null
...
const _sfc_main$1$1 = /* @__PURE__ */ defineComponent(__spreadProps$1(__spreadValues$1({}, __default__$1), {
  props: {
    tokens: null,
    getName: null
  },
...
function mapFile(file, existingFile) {
  const result = __spreadProps(__spreadValues({}, file), {
...
const _sfc_main = defineComponent({
  ...
  render() {
    ...
    if (firstVariant.id === "_default") {
      return h(_sfc_main$1, __spreadValues({
