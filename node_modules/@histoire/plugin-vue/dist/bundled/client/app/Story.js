...
import { defineComponent as l, getCurrentInstance as _, useAttrs as $, computed as x, provide as S, reactive as g, h as A, cloneVNode as C } from "vue";
      ...
      for (const o of e)
        if (((c = o.type) == null ? void 0 : c.__histoireType) === "variant") {
          ...
          for (const s in this.story)
            !u.includes(s) && typeof ((h = o.props) == null ? void 0 : h[s]) > "u" && (p[s] = this.story[s]);
          a++, r.push(C(o, p));
        } else
