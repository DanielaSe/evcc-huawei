  ...
  });
  {
    ...
    if (IS_CLIENT) {
      ["_p", "_hmrPayload", "_getters", "_customProperties"].forEach((p2) => {
        Object.defineProperty(store, p2, __spreadValues2({
          value: store[p2]
        }, nonEnumerable));
      });
    }
...
const computePosition$1 = async (reference, floating, config2) => {
  ...
  let {
    x: x2,
    y
  } = computeCoordsFromPlacement(__spreadProps2(__spreadValues2({}, rects), {
    placement
  }));
...
const _hoisted_3$1 = /* @__PURE__ */ createBaseVNode("div", { class: "v-popper__arrow-outer" }, null, -1);
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("div", { class: "v-popper__arrow-inner" }, null, -1);
const _hoisted_5$1 = [
  _hoisted_3$1,
  _hoisted_4$1
];
...
function fullIcon(data) {
  return __spreadValues2(__spreadValues2({}, iconDefaults), data);
}
...
function mergeIconData(icon, alias) {
  const result = __spreadValues2({}, icon);
...
const render = (icon, props) => {
  ...
  const componentProps = __spreadValues2({}, svgDefaults);
  let style2 = typeof props.style === "object" && !(props.style instanceof Array) ? __spreadValues2({}, props.style) : {};
...
const Icon = defineComponent({
  ...
  render() {
    ...
    let newProps = props;
    if (icon.classes) {
      newProps = __spreadProps2(__spreadValues2({}, props), {
...
export { nextTick as $, defineStore as A, useTitle as B, resolveDynamicComponent as C, createApp as D, createPinia as E, Fragment as F, plugin as G, useStorage as H, Icon as I, renderList as J, useEventListener as K, resolveDirective as L, withDirectives as M, defineAsyncComponent as N, vShow as O, isRef as P, useCssVars as Q, createTextVNode as R, reactive as S, Transition as T, useRoute as U, pushScopeId as V, popScopeId as W, useDark as X, useToggle as Y, vModelText as Z, h as _, openBlock as a, normalizeProps as a0, guardReactiveProps as a1, withScopeId as a2, getCurrentScope as a3, onScopeDispose as a4, useAttrs as a5, getCurrentInstance as a6, inject as a7, provide as a8, markRaw as a9, Tailwind_story$1 as aA, parseQuery as aa, Case as ab, Text as ac, vModelSelect as ad, vModelRadio as ae, vModelCheckbox as af, vModelDynamic as ag, useFocus as ah, refDebounced as ai, flexsearch as aj, toRefs as ak, useRouter as al, watchEffect as am, useResizeObserver as an, useTimeoutFn as ao, onClickOutside as ap, shallowRef as aq, getHighlighter as ar, Dropdown as as, setCDN as at, onBeforeUnmount as au, toRaw as av, createStaticVNode as aw, _export_sfc as ax, VTooltip as ay, useClipboard as az, createElementBlock as b, computed as c, defineComponent as d, createBaseVNode as e, renderSlot as f, withModifiers as g, normalizeStyle as h, unref as i, createBlock as j, withCtx as k, createVNode as l, createCommentVNode as m, normalizeClass as n, onUnmounted as o, onMounted as p, resolveComponent as q, ref as r, scrollIntoView as s, toDisplayString as t, useMediaQuery as u, withKeys as v, watch as w, mergeProps as x, createRouter as y, createWebHistory as z };
