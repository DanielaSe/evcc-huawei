...
function marktytoml (TOML) {
  var matchThis = new RegExp("^\\s*\\[(\\[)?(.*?)\\]\\]?(?= *$)((?:[\\w\\W](?!^\\s*\\[))*)", 'gm');
  var json = {};
  ...
  TOML = TOML.replace(/('{3,}(?:(?!'{3,})[\w\W]+?)'{3,})/gm, function (s, literal){
  ...
  markty(TOML, matchThis, function (string, match) {
...
function parseBody (TOML) {
  ...
  var matchThis = new RegExp("^[ \t]*(.+?) *[=:] *(?:\"((?!\")[\\w\\W]+?)\"|'{3,}((?!'{3,})[\\w\\W]+?)'{3,}|(\\[[\\w\\W]+?(?:(?: *])+ *$\\n*)+)|(\\{[\\w\\W]+?(?:(?: *})+ *$\\n*)+)|(.+) *)|^(.+)$", 'gm');
...
export default marktytoml;
//# sourceMappingURL=marktytoml.es.js.map
