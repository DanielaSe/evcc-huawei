import { defineComponent, ref, watch, computed, openBlock, createElementBlock, Fragment, createElementVNode, createVNode, unref, withDirectives, withKeys, withModifiers, vModelText, createBlock, withCtx, createTextVNode, renderList, createCommentVNode } from "@histoire/vendors/vue";
  ...
  setup(__props, { emit: __emit }) {
    ...
    const commandResults = computed(() => {
      if (__HISTOIRE_DEV__) {
        ...
        return allCommands.filter((command) => !command.showIf || command.showIf(commandCtx)).filter((command) => {
          var _a;
          return command.label.toLowerCase().includes(searchText) || ((_a = command.searchText) == null ? void 0 : _a.toLowerCase().includes(searchText));
